<template>
  <nav
    class="navbar navbar-expand-lg navbar-light bg-bake-brown position-fixed mw-100 w-100"
    style="z-index: 1000"
    ref="navOut"
  >
          ...
          <div class="collapse navbar-collapse justify-content-end" id="navbarNav01">
            ...
            >
              ...
              <li class="nav-item" @mouseenter="mouseEnter(0)" @click="setActive(0)">
                <router-link class="nav-link text-ota-white" @click="navbarHide" to="/about"
                  >關於我們</router-link
                >
              </li>
              <li class="nav-item" @mouseenter="mouseEnter(1)" @click="setActive(1)">
                <router-link class="nav-link text-ota-white" @click="navbarHide" to="/caffeine"
                  >咖啡與茶</router-link
                >
              </li>
