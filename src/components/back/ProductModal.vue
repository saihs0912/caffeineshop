            ...
            <div class="col-sm-4">
              ...
              <div class="mb-3">
                ...
                <input
                  ...
                  id="image"
                  placeholder="請輸入圖片連結"
                  @change="inputFile('imagesUrl')"
                  v-model="imagesUrl"
                  :disabled="(tempProduct.imagesUrl || []).length >= 4"
                />
              </div>
              <div class="mb-3">
                <label for="customFile" class="form-label"
                ...
                <input
                  ...
                  class="form-control"
                  ref="filesInput"
                  @change="uploadFile('filesInput')"
                  :disabled="(tempProduct.imagesUrl || []).length >= 4"
                />
              </div>
              <div
                class="d-flex flex-wrap flex-row bd-highlight"
              ...
              <div class="row gx-2">
                <div class="mb-3 col-md-6">
                  ...
                  >
                    ...
                    <option v-for="item in productList" :value="item" :key="item">
                      {{ item }}
                    </option>
                  </select>
                </div>
...
import { uploadFile } from '@/methods/api'
...
export default {
  ...
  methods: {
    ...
    inputFile(putImg) {
      putImg === 'imageUrl'
        ? (this.tempProduct[putImg] = this[putImg])
        : this.tempProduct[putImg].push(this[putImg])
      this[putImg] = ''
    },
    imageDel(i) {
